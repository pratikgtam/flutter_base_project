...
class _$DashboardStateImpl implements _DashboardState {
  _$DashboardStateImpl({this.data = const Result<void>.empty()});
  ...
  @override
  String toString() {
    return 'DashboardState(data: $data)';
  }
...
abstract class _DashboardState implements DashboardState {
  factory _DashboardState({final Result<void> data}) = _$DashboardStateImpl;
