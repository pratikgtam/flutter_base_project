...
class _$OnboardingStateImpl implements _OnboardingState {
  _$OnboardingStateImpl({this.data = const Result<void>.empty()});
  ...
  @override
  String toString() {
    return 'OnboardingState(data: $data)';
  }
...
abstract class _OnboardingState implements OnboardingState {
  factory _OnboardingState({final Result<void> data}) = _$OnboardingStateImpl;
